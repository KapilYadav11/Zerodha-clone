...
const WatchListItem = ({ stock }) => {
  ...
  return (
    <li
      ...
      className="p-4 flex items-center justify-between relative cursor-pointer hover:bg-gray-50 transition-colors h-[65px]"
    >
...
const WatchListActions = ({ uid }) => {
  ...
  return (
    <div className="absolute inset-y-0 right-0 bg-gradient-to-l from-white via-white to-transparent pl-12 pr-4 flex items-center gap-1.5">
      ...
      <Tooltip title="Sell" placement="top" arrow TransitionComponent={Grow}>
        <button className="px-2.5 py-1 text-xs font-semibold text-white bg-red-500 rounded shadow-sm hover:bg-red-600 transition-colors">
          S
        </button>
      </Tooltip>
